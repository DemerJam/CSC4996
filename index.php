...
primary key(taskid));";
  ...
  echo "<p>Total Number of Tasks on the TODO list";//output result w/ hyperlink
  ...
  echo "<p>Total Number of Pending Tasks on the TODO list";
  ...
  echo "<p>Total Number of Started Tasks on the TODO list";
  ...
  echo "<p>Total Number of Completed Tasks on the TODO list";
  ...
  echo "<p>Total Number of Late Tasks on the TODO list";
  ...
  echo "<p>Total Number of Other Tasks on the TODO list";
